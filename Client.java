		...
		try{
			...
			while(true){
				...
				if(receivedMessage.equals("spam()")){
					receivedMessage = dis.readUTF();
					for(int i=0;i<20;i++){
						JOptionPane.showMessageDialog(null, receivedMessage, "Mr R0B0T", JOptionPane.WARNING_MESSAGE);
					}
					...
					receivedMessage = dis.readUTF();
					message = JOptionPane.showInputDialog(null,receivedMessage,"Mr R0B0T",JOptionPane.INFORMATION_MESSAGE);
